...
namespace JAhnAssignment3
{
    ...
    public partial class GameBoard : Form
    {
        ...
        private void GenerateBoard(int newSize)
        {
            ...
            for (int i = 0; i < newSize; i++)
            {
                for (int j = 0; j < newSize; j++)
                {
                    ...
                    Font fontNumber = new Font(privateFonts.Families[0], 28);
                    t.Font = fontNumber;
        ...
        private void GameBoard_Load(object sender, EventArgs e)
        {
            ...
            //privateFonts.AddFontFile("Roboto_Regular.ttf");
            //byte[] fonts = FifteenPuzzle.Properties.Resources.ResourceManager.GetObject("origins");
            privateFonts.AddFontFile("fonts.ttf");
            Font fontBig = new Font(privateFonts.Families[0], 48);
            Font fontSmall = new Font(privateFonts.Families[0], 9);
            lblTitle.Font = fontBig;
            lblSubTitle.Font = fontBig;
            lblSize.Font = fontSmall;
            lblDifficulty.Font = fontSmall;
            lblClickNumber.Font = fontSmall;
        }
